...
/sbin/busybox mount -t rootfs -o remount,rw rootfs
	/sbin/busybox insmod /lib/modules/fuse.ko
	/sbin/busybox mkdir /mnt/ntfs
	/sbin/busybox mount -t tmpfs tmpfs /mnt/ntfs
...
mkdir -p /customkernel/property
	...
	echo "Kernel Apolo" >> /customkernel/property/customkernel.namedisplay 
...
then
	...
	if [ -f /system/Apolo/Desde_3-31.2- ];
	then
		...
		#Lo hacemos solo la primera vez
			...
			echo 1 > /system/Apolo/Desde_3-31.2- 
			/sbin/busybox mount /system -o remount,ro 
	fi
	#Borramos payload
	rm -rf /res/misc/*
